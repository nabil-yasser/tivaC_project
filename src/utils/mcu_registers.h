...
/**
 * @addtogroup System Control Block (SCB)
 * @{
*/
...
typedef struct
{
  ...
  __IOM uint32_t INTCTRL;                /*!< Offset: 0x004 (R/W)  Interrupt Control and State Register */
  __IOM uint32_t VTABLE;                 /*!< Offset: 0x008 (R/W)  Vector Table Offset Register */
  __IOM uint32_t APINT;                  /*!< Offset: 0x00C (R/W)  Application Interrupt and Reset Control Register */
  __IOM uint32_t SYSCTRL;                /*!< Offset: 0x010 (R/W)  System Control Register */
  __IOM uint32_t CFGCTRL;                /*!< Offset: 0x014 (R/W)  Configuration Control Register */
  __IOM uint8_t  SYSPRI[12U];            /*!< Offset: 0x018 (R/W)  System Handlers Priority Registers (4-7, 8-11, 12-15) */
  __IOM uint32_t SYSHNDCTRL;             /*!< Offset: 0x024 (R/W)  System Handler Control and State Register */
  __IOM uint32_t FAULTSTAT;              /*!< Offset: 0x028 (R/W)  Configurable Fault Status Register */
  __IOM uint32_t HFAULTSTAT;             /*!< Offset: 0x02C (R/W)  HardFault Status Register */
  __IM  uint32_t RESERVED0;              /*!< Offset: 0x030 (R/ )  NOT USED */
  __IOM uint32_t MMADDR;                 /*!< Offset: 0x034 (R/W)  MemManage Fault Address Register */
  __IOM uint32_t FAULTADDR;              /*!< Offset: 0x038 (R/W)  BusFault Address Register */
} SCB_Type;
...
typedef struct
{
  __IOM uint32_t EN[5U];                 /*!< Offset: 0x000 (R/W)  Interrupt Set Enable Register */
        uint32_t RESERVED0[27U];
  __IOM uint32_t DIS[5U];                /*!< Offset: 0x080 (R/W)  Interrupt Clear Enable Register */
        uint32_t RESERVED1[27U];
  __IOM uint32_t PEND[5U];               /*!< Offset: 0x100 (R/W)  Interrupt Set Pending Register */
        uint32_t RESERVED2[27U];
  __IOM uint32_t UNPEND[5U];             /*!< Offset: 0x180 (R/W)  Interrupt Clear Pending Register */
        uint32_t RESERVED3[27U];
  __IOM uint32_t ACTIVE[5U];             /*!< Offset: 0x200 (R/W)  Interrupt Active bit Register */
        uint32_t RESERVED4[59U];
  __IOM uint8_t  PRI[140U];              /*!< Offset: 0x300 (R/W)  Interrupt Priority Register (8Bit wide) */
        uint32_t RESERVED5[564U];
  __OM  uint32_t SWTRIG;                 /*!< Offset: 0xE00 ( /W)  Software Trigger Interrupt Register */
}  NVIC_Type;
...
/** @} */ /* End of group System Control Block (SCB) */
